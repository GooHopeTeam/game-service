...
public record FullGameDtoResponse(Long id,
                                  String name,
    ...
    public static FullGameDtoResponse fromModel(Game game) {
        ...
        return new FullGameDtoResponse(game.getId(), game.getName(), game.getShortDescription(), game.getFullDescription(),
